...
export class AppConfigComponent implements OnInit {
    ...
    changeTheme(theme: string) {
        ...
        if (theme === 'yellow' || theme === 'lime') {
            topbarLogo.src = 'assets/layout/images/logo-black.svg';
            menuLogo.src = 'assets/layout/images/logo-black.svg';
        } else {
            topbarLogo.src = 'assets/layout/images/logo-white.svg';
            menuLogo.src = 'assets/layout/images/logo-white.svg';
        }
    }
